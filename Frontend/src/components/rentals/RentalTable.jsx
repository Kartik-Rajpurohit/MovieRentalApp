...
export default function RentalTable() {
  ...
  return (
    <div>
      ...
      >
        <Column field="rentalId" header="ID" sortable style={{ width: "80px" }} />
        <Column field="filmTitle" header="Film" sortable />
        <Column field="customerName" header="Customer" body={(r) => (
          <span style={{ textTransform: "capitalize" }}>
            {r.customerName?.toLowerCase()}
          </span>
        )} />
        <Column field="staffName" header="Staff" body={(r) => (
          <span style={{ textTransform: "capitalize" }}>
            {r.staffName?.toLowerCase()}
          </span>
        )} />
        <Column field="rentalDate" header="Rented On" sortable
          body={(r) => dateBody(r.rentalDate)} style={{ width: "120px" }} />
        <Column field="returnDate" header="Returned On"
          body={(r) => dateBody(r.returnDate)} style={{ width: "130px" }} />
